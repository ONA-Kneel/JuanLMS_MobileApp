  ...
  const containerStyle = {
    ...
    transform: [{
      translateX: translateRef.current.x.interpolate({
        inputRange: [0, snapAlignmentsRef.current[FloatingViewAlignment.topRight].x],
        outputRange: [0, snapAlignmentsRef.current[FloatingViewAlignment.topRight].x],
        extrapolate: 'clamp'
      })
    }, {
      translateY: translateRef.current.y.interpolate({
        inputRange: [0, snapAlignmentsRef.current[FloatingViewAlignment.bottomRight].y],
        outputRange: [0, snapAlignmentsRef.current[FloatingViewAlignment.bottomRight].y],
        extrapolate: 'clamp'
      })
    }]
  };
