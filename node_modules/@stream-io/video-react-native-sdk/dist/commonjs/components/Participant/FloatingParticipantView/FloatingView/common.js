...
exports.floatingChildViewContainerStyle = exports.FloatingViewAlignment = void 0;
...
function getClosestSnapAlignment({
  ...
  for (const key in snapAlignments) {
    ...
    const currDistanceSquared = (offset.x - position.x) * (offset.x - position.x) + (offset.y - position.y) * (offset.y - position.y);
...
const floatingChildViewContainerStyle = exports.floatingChildViewContainerStyle = {
