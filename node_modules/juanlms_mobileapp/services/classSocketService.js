...
class ClassSocketService {
  ...
  joinClass(classId) {
    try {
      ...
      if (!this.isConnected) {
        socketLog('warn', 'CLASS_SOCKET_SERVICE', `Cannot join class ${classId} - socket not connected. Will retry when connected.`);
      return;
    }
...
export default classSocketService;
  ...
  joinClass(classId) {
    ...
    if (!this.socket || !this.isConnected) {
      ...
      console.log('[ClassSocketService] Socket not connected, cannot join class');
    ...
    console.log(`[ClassSocketService] Joining class: ${classId}`);
  ...
  leaveClass(classId) {
    ...
    if (!this.socket || !this.isConnected) {
      ...
      console.log('[ClassSocketService] Socket not connected, cannot leave class');
    ...
    console.log(`[ClassSocketService] Leaving class: ${classId}`);
