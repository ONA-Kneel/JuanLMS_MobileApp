...
export default function AdminSupportCenter() {
  ...
  useEffect(() => {
    const s = io('https://juanlms-mobileapp.onrender.com');
    setSocket(s);
  ...
  const fetchTickets = async () => {
    const res = await fetch(`https://juanlms-mobileapp.onrender.com/api/tickets?status=${activeTab}`);
          ...
          <View style={{
              ...
              {activeTab === 'opened' && (
                <>
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      await fetch(`https://juanlms-mobileapp.onrender.com/api/tickets/${selectedTicket._id}/close`, { method: 'POST' });
                      setSelectedTicket(null);
                      fetchTickets();
                    }}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      await fetch(`https://juanlms-mobileapp.onrender.com/api/tickets/${selectedTicket._id}/open`, { method: 'POST' });
                      setSelectedTicket(null);
                      fetchTickets();
                    }}
                  >
                ...
                <>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      ...
                      if (confirmed) {
                        await fetch(`https://juanlms-mobileapp.onrender.com/api/tickets/${selectedTicket._id}`, { method: 'DELETE' });
                        setSelectedTicket(null);
                        fetchTickets();
                      }
                    }}
            ...
            <View style={{
              ...
              <TouchableOpacity onPress={async () => {
                ...
                await fetch(`https://juanlms-mobileapp.onrender.com/api/tickets/${selectedTicket._id}/reply`, {
                  method: 'POST',
