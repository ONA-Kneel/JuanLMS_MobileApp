    ...
    return (
        <ScrollView style={StudentProgStyle.container}>
            ...
            <View style={StudentProgStyle.card}>
                ...
                <ProgressBar progress={.6} color="black" style={StudentProgStyle.progressBar} />
                <Ionicons name="arrow-forward-circle" size={24} color="white" style={StudentProgStyle.arrowIcon} />
            </View>

            <View style={StudentProgStyle.row}>
                <View style={StudentProgStyle.chartContainer}>
                    <Text style={StudentProgStyle.sectionTitle}>Student Growth</Text>
                   
                </View>

                <View style={StudentProgStyle.peerAnalysis}>
                    <Text style={StudentProgStyle.sectionTitle2}>Peer Analysis</Text>
                    <Text style={StudentProgStyle.errorBox}>TBA</Text>
                </View>
            </View>
            ...
            <View style={StudentProgStyle.card}>
                ...
                <Text style={StudentProgStyle.feedback}>Doing better this week, keep it up!</Text>
            </View>
        </ScrollView>
    );
}
