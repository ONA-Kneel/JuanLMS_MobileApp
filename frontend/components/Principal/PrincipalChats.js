// PrincipalChats.js - Mobile version matching web Principal_Chats.jsx
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        // On web, convert the file URI to a Blob
        if (Platform.OS === 'web') {
      ...
      if (response.ok) {
        ...
        // Emit message through socket (uses `text` key for realtime)
        if (socket.current) {
