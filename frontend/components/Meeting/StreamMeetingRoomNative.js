...
// InCallManager removed - was causing iOS crashes
...
export default function StreamMeetingRoomNative({
	...
	useEffect(() => {
		...
		const join = async () => {
			...
			try {
				...
				// InCallManager removed - using native audio handling instead
	...
	const handleLeave = useCallback(async () => {
		...
		// InCallManager cleanup removed - using native audio handling instead
		if (onLeave) onLeave();
		if (onClose) onClose();
