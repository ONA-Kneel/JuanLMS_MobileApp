  ...
  return (
    <View style={FacultyProfileStyle.container}>
      ...
      >
        <View style={FacultyProfileStyle.modalContainer}>
          <View style={FacultyProfileStyle.modalContent}>
            <Text style={[FacultyProfileStyle.modalTitle, { fontFamily: 'Poppins-Bold', marginBottom: 20, textAlign: 'center' }]}>
              Confirm Profile Photo
            </Text>
            <Text style={[FacultyProfileStyle.modalSubtitle, { fontFamily: 'Poppins-Regular', marginBottom: 20, textAlign: 'center' }]}>
              Are you sure you want this photo as your profile?
            </Text>
            
            {/* Photo Preview */}
            <View style={[FacultyProfileStyle.imagePicker, { marginBottom: 30, alignSelf: 'center' }]}>
              <Image
                source={selectedPhotoAsset
                  ? { uri: selectedPhotoAsset.uri }
                  : require('../../assets/profile-icon (2).png')}
                style={[FacultyProfileStyle.avatar, { width: 120, height: 120 }]}
                resizeMode="cover"
              />
            </View>
            ...
            <View style={FacultyProfileStyle.modalButtons}>
              ...
              >
                {isLoading ? (
                  ...
                  <Text style={[FacultyProfileStyle.buttonText, { fontFamily: 'Poppins-Regular' }]}>Yes</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
